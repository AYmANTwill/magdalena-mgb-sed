...
- `01_dem_preprocessing.ipynb` — DEM → minibacias: ASCII/NODATA, pit filling (Planchon-Darboux), D8 flow
  direction, flow accumulation, stream definition, segmentation, watershed/catchment delineation.
- `02_urh_soil_landuse.ipynb` — URH: soil × land-cover crossing, Fréchet bounds, per-minibacia composition,
