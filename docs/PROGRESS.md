...
- [ ] 🔴 **C1.0 resolve network size** — coordinate+area fetch for the 46 unmapped (only **28/79 mapped**, 24 safe); decide (a) fetch raises count or (b) run on mapped subset — *NEW, must precede C1.1* (docs/31 C1.0, F1)
