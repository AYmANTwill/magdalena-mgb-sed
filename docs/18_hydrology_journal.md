...
| 20 | **CHIRPS merge not attempted** — and after [doc 24](24_phase3_refit.md) it is the **only remaining lever on the dry phase** (§14). Quantile-map CHIRPS *to* the gauge distribution so volume stays gauge-controlled; gate on LOOCV beating 0.429. 41,180 fallback cells remain, nearest gauge median 16.3 km / max 71.5 km | the r ceiling of [doc 22 §4.7](22_dry_phase_diagnosis.md) |
---
